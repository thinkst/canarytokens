import{_ as r}from"./BaseCodeSnippet.vue_vue_type_script_setup_true_lang-0CGpcB1X.js";import{d as o,r as i,a as c,b as l,u as m}from"./index-Ba78S-Tl.js";function u(e){const n=`
...
--create a table-view function to query the canary hostname
  ...
  alter view ${e.sql_server_view_name} as select * from master.dbo.(rand());
  ...
  --don't allow [public] to view the definitions`;return e.sql_action==="SELECT"?a:n}const b=o({__name:"TokenDisplay",props:{tokenData:{}},setup(e){const n=e,a=i({hostname:n.tokenData.hostname,sql_table_name:n.tokenData.sql_table_name,sql_trigger_name:n.tokenData.sql_trigger_name,sql_function_name:n.tokenData.sql_function_name,sql_server_view_name:n.tokenData.sql_server_view_name,sql_action:n.tokenData.sql_action}),s=u(a.value);return(d,_)=>{const t=r;return c(),l(t,{lang:"sql",label:"Microsoft Server SQL token",code:m(s),"custom-height":"10rem","show-expand-button":""},null,8,["code"])}}});export{b as _};
