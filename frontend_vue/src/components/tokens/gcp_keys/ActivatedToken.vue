<template>
  ...
  <p class="mt-16 text-sm">
    This token is triggered when someone uses this credential pair to access GCP
...
const tokenData = ref({
  gcp_keyfile: props.tokenData.gcp_keyfile || '',
  gcp_service_account_email: props.tokenData.gcp_service_account_email || '',
});
</script>
