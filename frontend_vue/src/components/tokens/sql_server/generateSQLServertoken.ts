...
-- To allow database users, who only have the public database role, to run "SELECT" queries against the dbo.${SQLData.sql_server_view_name} view:
--    Grant the public database role "SELECT" permission on the dbo.${SQLData.sql_function_name} function.
--    Grant the public database role "SELECT" permission on the dbo.${SQLData.sql_server_view_name} view.
--    Do not grant the public database role "VIEW DEFINITION" permission on either the dbo.${SQLData.sql_function_name} function or the dbo.${SQLData.sql_server_view_name} view.
`;
