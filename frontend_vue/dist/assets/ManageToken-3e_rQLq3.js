import{a as p}from"./BaseCodeSnippet.vue_vue_type_script_setup_true_lang-BnB0Smqi.js";import{d as _,a as d,o as c,e as u,u as h,c as v}from"./index-BuN6Wgu_.js";function k(e){const n=`
...
--create a table-view function to query the canary hostname
  ...
  --don't allow [public] to view the definitions`;return e.sql_action==="SELECT"?n:a}const b=_({__name:"TokenDisplay",props:{tokenData:{}},setup(e){const n=e,a=d({hostname:n.tokenData.hostname,sql_table_name:n.tokenData.sql_table_name,sql_trigger_name:n.tokenData.sql_trigger_name,sql_function_name:n.tokenData.sql_function_name,sql_server_view_name:n.tokenData.sql_server_view_name,sql_action:n.tokenData.sql_action}),s=k(a.value);return(r,o)=>{const t=p;return c(),u(t,{lang:"sql",label:"Microsoft Server SQL token",code:h(s),multiline:"","custom-height":"10rem"},null,8,["code"])}}}),E={key:0},R=_({__name:"ManageToken",props:{tokenBackendResponse:{}},setup(e){var s,r,o,t,i,l,m;const n=e,a=d({hostname:(s=n.tokenBackendResponse.canarydrop)==null?void 0:s.generated_hostname,sql_table_name:(r=n.tokenBackendResponse.canarydrop)==null?void 0:r.sql_server_table_name,sql_trigger_name:(o=n.tokenBackendResponse.canarydrop)==null?void 0:o.sql_server_trigger_name,sql_function_name:(i=(t=n.tokenBackendResponse)==null?void 0:t.canarydrop)==null?void 0:i.sql_server_function_name,sql_server_view_name:(l=n.tokenBackendResponse.canarydrop)==null?void 0:l.sql_server_view_name,sql_action:(m=n.tokenBackendResponse.canarydrop)==null?void 0:m.sql_server_sql_action});return(q,A)=>a.value?(c(),u(b,{key:1,"token-data":a.value},null,8,["token-data"])):(c(),v("div",E,"Error loading"))}});export{R as default};
